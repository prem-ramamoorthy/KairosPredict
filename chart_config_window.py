...
def chart_config(root, switch_event , switch_var):
    ...
    ctk.CTkLabel(main_frame , text = "Volume Down color").grid(row = 3 , column= 2, padx = 5 , pady= 5)
    ...
    down_volume_color_button = ctk.CTkButton(main_frame, text="" ,border_width=1,border_color="black",corner_radius=60, width=20, height=20, fg_color=list_of_select_colors[7], command=lambda :pick_color(down_volume_color_button , 7))
    down_volume_color_button.grid(row = 3 , column = 3 , padx = 10 , pady = 10 , sticky = "w")
