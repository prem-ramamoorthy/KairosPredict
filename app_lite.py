...
def open_stock_ui():
    ...
    moving_average_options = ctk.CTkComboBox(element_frame, values=["Simple Moving Average", "Exponential Moving Average", "⚠️Weighted Moving Average", "Triangular Moving Average", "⚠️Kaufman Adaptive Moving Average", "Hull Moving Average", "⚠️Volume Weighted Moving Average" ] , command= setmovingaverage) 
